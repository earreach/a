...
var IsAdmin = window.parent.DTAdmin ? true : false;//DT 2022/5/23
var HDHtml = !IsAdmin && !window.parent.EHM;//DT 2023/02/02
...
if(HDHtml) FCKConfig.ToolbarSets["Default"][0].splice(0,2);
...
if(HDHtml) FCKConfig.ToolbarSets["Destoon"][0].splice(0,2);
if(window.parent.ModuleID == 18) FCKConfig.ToolbarSets["Destoon"][0].splice(-1,0,'Smiley');


FCKConfig.ToolbarSets["Simple"] = [
	['Source','-','Bold','Italic','Underline','TextColor','-','FontSize','Link','Unlink','-','Image','Flash','JustifyLeft','JustifyCenter','JustifyRight','-','RemoveFormat','Attach','FitWindow']
];
if(HDHtml) FCKConfig.ToolbarSets["Simple"][0].splice(0,2);
if(window.parent.ModuleID == 18) FCKConfig.ToolbarSets["Simple"][0].splice(-1,0,'Smiley');


FCKConfig.ToolbarSets["Basic"] = [
	['Source','-','Bold','TextColor','-','Link','Unlink','-','Image','Flash','JustifyLeft','JustifyCenter','JustifyRight','RemoveFormat','FitWindow']
];
if(HDHtml) FCKConfig.ToolbarSets["Basic"][0].splice(0,2);
if(window.parent.ModuleID == 18) FCKConfig.ToolbarSets["Basic"][0].splice(-1,0,'Smiley');

FCKConfig.ToolbarSets["Message"] = [
	['Source','-','Bold','Italic','Underline','TextColor','-','FontSize','Link','Unlink','-','Image','Flash','Smiley','JustifyLeft','JustifyCenter','JustifyRight','-','RemoveFormat','Attach','FitWindow']
];
if(HDHtml) FCKConfig.ToolbarSets["Message"][0].splice(0,2);
