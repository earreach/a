...
$editor .= 'var EHM = '.($DT['editor_html'] ? 1 : 0).';';
$editor .= 'var FCKID = "'.$textareaid.'";';
$editor .= '</script>';
$editor .= '<script type="text/javascript" src="'.$moddir.'fckeditor/fckeditor.js?v='.DT_REFRESH.'"></script>';
$editor .= '<script type="text/javascript">';
...
$editor .= '}';
$editor .= '</script>';
$editor .= '<script type="text/javascript" src="'.$moddir.'fckeditor/init.api.js?v='.DT_REFRESH.'"></script>';
