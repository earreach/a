...
(function(){
    ...
    function insertSingle(){
		...
		//console.log(player(url, width.value||420, height.value||280));
		//editor.execCommand("inserthtml",player(url, width.value||420, height.value||280),true);
    ...
    function createPreviewVideo(url){
		...
		$G("preview").innerHTML = player(conUrl, 420, 280);
		/*
