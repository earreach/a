...
function html_frame(u, w, h) {return '<iframe src="'+u+'" width="'+w+'" height="'+h+'" frameborder="0" scrolling="no" allowfullscreen="true" allowtransparency="true" allow="autoplay; encrypted-media"></iframe>';}
function html_play(u) {return '<a href="'+u+'" target="_blank" rel="external"><div style="width:100%;height:200px;background:#000000 url('+DTPath+'/static/image/play.png) no-repeat center center;background-size:48px 48px;"></div></a>';}
