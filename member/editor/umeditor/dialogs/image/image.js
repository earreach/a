...
//                }
    ...
    UM.registerWidget('image', {
        tpl: "<link rel=\"stylesheet\" type=\"text/css\" href=\"<%=image_url%>image.css\">" +
            ...
            "<table><tr><td style=\"border:none;\"><input class=\"edui-image-searchTxt\" type=\"text\" id=\"url\"></td>" +
            "<td style=\"border:none;\"><div class=\"edui-image-searchAdd\" id=\"urladd\"><%=lang_btn_add%></div><div class=\"edui-image-searchAdd nocalss\" onclick=\"window.open(AJPath+'?action=choose&moduleid='+ModuleID+'&from=umeditor','dwindow','height=500px,width=888px,top=100px,left=300px,resizable=no,scrollbars=yes');\">相册</div></td></tr></table>" +
            "</div>" +
