(function () {
    ...
    UM.registerWidget(widgetName, {
        ...
        tpl: "<style type=\"text/css\">" +
            ...
            ".edui-dialog-map .edui-map-content table td{vertical-align: middle;border:none;padding:0;}" +
            ...
            ".edui-dialog-map .edui-map-address{width:248px}" +
            ...
            "<td style=\"display:none;\"><label class=\"edui-map-dynamic-label\"><input class=\"edui-map-dynamic\" type=\"checkbox\" name=\"edui-map-dynamic\" /><span><%=lang_dynamicmap%></span></label></td>"+
            "</tr>" +
            "</table>" +
            ...
            " } }" +
            "</scr_ipt>" +
            "<scr_ipt onreadystatechange='mapReadyStateChange(this.readyState);' onload='mapReadyStateChange(\"loaded\");' src=\"https://api.map.baidu.com/api?v=2.0&ak="+(MAK ? MAK : '6b6c1a67eaa7db1ca6d6da28e590e343')+"&services=true\"></scr_ipt>" +
            "</body>" +
            "</html>" +
            "</script>",
