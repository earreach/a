...
<th>标题</th>
<th>会员</th>
<th><a href="javascript:;" onclick="Dq('order','<?php echo $order == 25 ? 26 : 25;?>');">信息 <img src="<?php echo DT_STATIC;?>image/ico-<?php echo $order == 26 ? 'asc' : ($order == 25 ? 'dsc' : 'ord');?>.png" width="11" height="11"/></a></th>
...
<td><a href="javascript:;" onclick="Dwidget('?moduleid=<?php echo $moduleid;?>&file=item&specialid=<?php echo $v['itemid'];?>', '[<?php echo $v['alt'];?>] 信息列表');"><?php echo $v['items'];?></a></td>
...
<td><a href="javascript:;" onclick="Dwidget('?moduleid=<?php echo $moduleid;?>&file=item&action=add&specialid=<?php echo $v['itemid'];?>', '[<?php echo $v['alt'];?>] 信息列表');"><img src="<?php echo DT_STATIC;?>admin/add.png" width="16" height="16" title="向此专题位添加信息" alt=""/></a></td>
<td><a href="javascript:;" onclick="Dwidget('?moduleid=<?php echo $moduleid;?>&file=item&specialid=<?php echo $v['itemid'];?>', '[<?php echo $v['alt'];?>] 信息列表');"><img src="<?php echo DT_STATIC;?>admin/child.png" width="16" height="16" title="此专题信息列表" alt=""/></a></td>
