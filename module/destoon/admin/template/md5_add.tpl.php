...
<?php if($k%4==0) {?><tr><?php } ?>
<td width="150"><input type="checkbox" name="dirs[]" value="<?php echo $d;?>"<?php echo in_array($d, $sys) ? ' checked' : '';?>/>&nbsp;<img src="<?php echo DT_STATIC;?>admin/dir.gif" width="16" height="16" alt="" align="absmiddle"/> <?php echo $d;?></td>
<?php if($k%4==3) {?></tr><?php } ?>
<?php } ?>
</table>
</td>
