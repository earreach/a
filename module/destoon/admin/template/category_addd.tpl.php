...
<form method="post" action="?" onsubmit="return Dcheck();" enctype="multipart/form-data">
<input type="hidden" name="file" value="<?php echo $file;?>"/>
<input type="hidden" name="action" value="<?php echo $action;?>"/>
<input type="hidden" name="category[parentid]" value="<?php echo $parentid;?>"/>
...
<tr>
    <td>
    <input type="submit" value="上传文件11" name="submit" onclick="()">
    </td>
</tr>
...
<script>
  ...
  //   if($('#fileToUpload1').value)  alert  ($('#fileToUpload1').value   return false)
  //   if($('#fileToUpload2').value)  alert  ($('#fileToUpload2').value   return false)
  //     return false
  //   }
