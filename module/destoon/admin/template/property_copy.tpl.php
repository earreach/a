...
<td>
	<label><input type="radio" name="type" value="1" id="t1" onclick="Ds('f1');Dh('f2');" checked/> 批量</label>&nbsp;&nbsp;&nbsp;&nbsp;
	<label><input type="radio" name="type" value="0" id="t2" onclick="Ds('f2');Dh('f1');"/> 单项</label>
</td>
</tr>
...
<td>
<?php echo category_select('fromid', '选择分类', 0, $_id, 'size="2" style="width:200px;height:130px;font-size:14px;"');?>
...
<td>
	<label><input type="radio" name="name" value="1" id="n1" checked/> 是</label>&nbsp;&nbsp;&nbsp;&nbsp;
	<label><input type="radio" name="name" value="0" id="n2"/> 否</label>
</td>
</tr>
</table>
