...
<input type="button" value="重新检测" class="btn" onclick="Go('?file=<?php echo $file;?>&action=<?php echo $action;?>');"/>
</td>
</tr>
</table>
</form>
...
<tr align="center">
<td align="left">&nbsp;&nbsp;<img src="file/ext/htm.gif" align="absmiddle"/> <a href="?moduleid=<?php echo $mid;?>&action=<?php echo $act;?>&kw=<?php echo $v['kw'];?>" target="_blank"><?php echo $v[$key];?></a></td>
<td><?php echo $v['num'];?></td>
<td><a href="?moduleid=<?php echo $mid;?>&action=<?php echo $act;?>&kw=<?php echo $v['kw'];?>" target="_blank"><img src="<?php echo DT_STATIC;?>admin/link.png" width="16" height="16"/></a></td>
</tr>
<?php }?>
<?php } else { ?>
<tr>
<td class="f_blue" height="40">&nbsp;- 指定范围没有检测到重复信息&nbsp;&nbsp;&nbsp;&nbsp;<a href="?file=<?php echo $file;?>&action=<?php echo $action;?>" class="t">[重新检测]</a></td>
</tr>
<?php } ?>
</table>
<?php } ?>
