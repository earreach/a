...
<th width="150">修改时间</th>
	...
	<tr align="center">
	<td align="left" class="f_fd">&nbsp;<img src="file/ext/<?php echo is_file(DT_ROOT.'/file/ext/'.file_ext($f).'.gif') ? file_ext($f) : 'oth';?>.gif" alt="" align="absmiddle"/> <?php echo $f;?></td>
	<td><?php echo dround(filesize(DT_ROOT.'/'.$f)/1024);?> Kb</td>
	<td><?php echo timetodate(filemtime(DT_ROOT.'/'.$f), 6);?></td>
	</tr>
	<?php } ?>
	<tr>
...
<tr>
<td class="tl">&nbsp;文件类型</td>
<td>&nbsp;<input type="text" size="55" name="fileext" value="<?php echo $fileext;?>" class="f_fd"/></td>
</tr>
<tr>
<td class="tl">&nbsp;镜像文件</td>
