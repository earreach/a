...
<tr class="on">
<td>
<label><input type="radio" name="fromtype" value="catid" <?php echo $itemid ? '' : 'checked';?>/>从指定分类ID</label>&nbsp;&nbsp;&nbsp;&nbsp;
<label><input type="radio" name="fromtype" value="itemid" <?php echo $itemid ? 'checked' : '';?>/>从指定<?php echo $MOD['name'];?>ID</label>
</td>
<td></td>
<td>&nbsp;目标分类</td>
</tr>
...
<tr align="center">
<td><a href="javascript:;" onclick="showid()" class="t">[分类ID查询]</a></td>
