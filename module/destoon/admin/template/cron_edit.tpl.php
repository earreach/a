...
<td>
<label><input type="radio" name="post[run]" value="0"  <?php if(!$run){ ?>checked <?php } ?> onclick="Ds('run_0');Dh('run_1');"/> 间隔执行</label>&nbsp;&nbsp;
<label><input type="radio" name="post[run]" value="1"  <?php if($run){ ?>checked <?php } ?> onclick="Dh('run_0');Ds('run_1');"/> 每天执行</label>
</td>
</tr>
...
<td>
<label><input type="radio" name="post[status]" value="0"  <?php if(!$status){ ?>checked <?php } ?>/> 正常</label>&nbsp;&nbsp;
<label><input type="radio" name="post[status]" value="1"  <?php if($status){ ?>checked <?php } ?>/> 禁用</label>
</td>
</tr>
<tr>
