...
<td align="left">&nbsp;<a href="<?php echo gourl($v['domain']);?>" target="_blank"><?php echo $v['sitename'];?></a></td>
<td><a href="javascript:;" onclick="Dq('fields',2,0);Dq('kw','='+this.innerHTML);"><?php echo $v['domain'];?></a></td>
<td><a href="javascript:;" onclick="Dq('fields',3,0);Dq('kw','='+this.innerHTML);"><?php echo $v['mark'];?></a></td>
<td><a href="javascript:;" onclick="Dq('fields',4,0);Dq('kw','='+this.innerHTML);"><?php echo $v['encode'];?></a></td>
<td title="<?php echo $v['editor'];?>"><?php echo $v['edittime'];?></td>
