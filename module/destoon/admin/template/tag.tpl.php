...
<a href="javascript:;" onclick="Dict();" class="t">[数据字典]</a> &nbsp;
<a href="javascript:;" onclick="Dd('stable').innerHTML=Dd('alltable').value;void(0);" class="t">[显示所有]</a>
...
<td>
<label><input type="radio" name="setting[child]" value="1" checked/> 是</label>&nbsp;&nbsp;&nbsp;&nbsp;
<label><input type="radio" name="setting[child]" value="0" id="child"/> 否</label>
</td>
<td>child</td>
</tr>
<tr>
...
<td>
<label><input type="radio" name="setting[areachild]" value="1" checked/> 是</label>&nbsp;&nbsp;&nbsp;&nbsp;
<label><input type="radio" name="setting[areachild]" value="0" id="areachild"/> 否</label>
</td>
<td>areachild</td>
</tr>
<tr>
...
<table cellspacing="0" class="tb">
<tr class="dsn" data-html="1">
<td class="tl"><span class="f_hid">*</span> 自定义CSS</td>
<td><textarea name="tag_css" id="tag_css" style="width:98%;height:48px;" class="f_fd"></textarea> 
</td>
</tr>
<tr class="dsn" data-html="1">
<td class="tl"><span class="f_hid">*</span> HTML开始标签</td>
<td><input type="text" name="tag_html_s" id="tag_html_s" size="30" value="<div class=&#34;&#34;>" class="f_fd"/></td>
</tr>
<tr>
<td class="tl"><span class="f_red">*</span> 标签代码</td>
<td><textarea name="tag_code" id="tag_code" style="width:98%;height:48px;color:green;" class="f_fd"></textarea> 
</td>
</tr>
<tr class="dsn" data-html="1">
<td class="tl"><span class="f_hid">*</span> HTML结束标签</td>
<td><input type="text" name="tag_html_e" id="tag_html_e" size="10" value="</div>" class="f_fd"/></td>
</tr>
<tr>
<td class="tl"></td>
<td>
<input type="submit" name="submit" value="预览标签" class="btn-g"/>&nbsp;&nbsp;&nbsp;&nbsp;
<input type="button" value="标签样式" class="btn" onclick="$('[data-html]').toggle();"/>&nbsp;&nbsp;&nbsp;&nbsp;
<input type="button" value="复制标签" class="btn" data-clipboard-action="copy" data-clipboard-target="#tag_code" onclick="if(Dd('tag_code').value){Dtoast('标签已复制');}else{Dtoast('请生成标签');}"/>
</td>
</tr>
</table>
</form>
...
function Dict() {
	...
	Dwidget('?file=<?php echo $file;?>&action=find&mid='+Dd('moduleid').value+'&tb='+Dd('table').value, '数据字典');
}
</script>
