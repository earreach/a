...
<label><input type="checkbox" name="albums" value="1"<?php echo $albums ? ' checked' : '';?>/> 专辑&nbsp;</label>
...
<th width="16"></th>
<th>会员</th>
<th><a href="javascript:;" onclick="Dq('order','<?php echo $order == 25 ? 26 : 25;?>');">图片 <img src="<?php echo DT_STATIC;?>image/ico-<?php echo $order == 26 ? 'asc' : ($order == 25 ? 'dsc' : 'ord');?>.png" width="11" height="11"/></a></th>
...
<td><a href="javascript:;" onclick="Dwidget('?moduleid=<?php echo $moduleid;?>&action=item&itemid=<?php echo $v['itemid'];?>', '[<?php echo $v['alt'];?>] 图片列表');"><img src="<?php echo $v['thumb'] ? $v['thumb'] : DT_STATIC.'image/nopic60.png';?>" width="60" class="thumb"/></a></td>
<td>
<div class="lt">
<?php if($v['status'] == 3) {?>
...
<td><?php if($v['open']<3) {?><a href="javascript:;" onclick="Dq('open','<?php echo $v['open'];?>');"><img src="<?php echo DT_STATIC;?>admin/lock.gif"/></a><?php } ?></td>
...
<td><a href="javascript:;" onclick="Dwidget('?moduleid=<?php echo $moduleid;?>&action=item&itemid=<?php echo $v['itemid'];?>', '[<?php echo $v['alt'];?>] 图片列表');"><?php echo $v['items'];?></a></td>
...
<td><a href="javascript:;" onclick="Dwidget('?moduleid=<?php echo $moduleid;?>&action=item&itemid=<?php echo $v['itemid'];?>', '[<?php echo $v['alt'];?>] 图片列表');"><img src="<?php echo DT_STATIC;?>admin/photo.png" width="16" height="16" title="管理图片" alt=""/></a></td>
