...
<td><input name="post[album]" type="text" size="30" value="<?php echo $album;?>"/> <?php tips('填写一个'.$MOD['name'].'的关键词或者专辑名称，以便关联同专辑的'.$MOD['name']);?></td>
</tr>
<tr>
...
<td class="tr">
<label><input type="radio" name="post[open]" value="3" <?php if($open == 3) echo 'checked';?> id="o_3" onclick="Dh('op_2');Dh('op_1');"/> 开放</label>
<label><input type="radio" name="post[open]" value="2" <?php if($open == 2) echo 'checked';?> id="o_2" onclick="Ds('op_2');Dh('op_1');"/> 密码验证</label>
<label><input type="radio" name="post[open]" value="1" <?php if($open == 1) echo 'checked';?> id="o_1" onclick="Dh('op_2');Ds('op_1');"/> 问题验证</label>
</td>
</tr>
...
<td class="tr"><input name="post[question]" type="text" id="question" size="30" value="<?php echo $question;?>"/> &nbsp; 答案 &nbsp; <input name="post[answer]" type="text" id="answer" size="30" value="<?php echo $answer;?>"/> <span id="dqa" class="f_red"></span></td>
</tr>
<tr>
