...
<label><input type="checkbox" name="price" value="1"<?php echo $price ? ' checked' : '';?>/>标价&nbsp;</label>
<label><input type="checkbox" name="vip" value="1"<?php echo $vip ? ' checked' : '';?>/><?php echo VIP;?>&nbsp;</label>
<label><input type="checkbox" name="elite" value="1"<?php echo $elite ? ' checked' : '';?>/>橱窗&nbsp;</label>
</td>
</tr>
<tr>
<td>
...
<th>会员</th>
<th><a href="javascript:;" onclick="Dq('order','<?php echo $order == 33 ? 34 : 33;?>');">价格 <img src="<?php echo DT_STATIC;?>image/ico-<?php echo $order == 34 ? 'asc' : ($order == 33 ? 'dsc' : 'ord');?>.png" width="11" height="11"/></a></th>
...
<th><a href="javascript:;" onclick="Dq('order','<?php echo $order == 29 ? 30 : 29;?>');">询价 <img src="<?php echo DT_STATIC;?>image/ico-<?php echo $order == 30 ? 'asc' : ($order == 29 ? 'dsc' : 'ord');?>.png" width="11" height="11"/></a></th>
...
<td><?php echo $v['price'] ? $DT['money_sign'].$v['price'] : '';?><?php echo $v['unit'] ? $DT['money_unit'].'/'.$v['unit'] : '';?></td>
...
<td><a href="javascript:;" onclick="Dwidget('?moduleid=2&file=message&status=3&mid=<?php echo $moduleid;?>&tid=<?php echo $v['itemid'];?>', '[<?php echo $v['alt'];?>] 询价记录');"><?php echo $v['messages'];?></a></td>
