...
<td>
<label><input type="radio" name="setting[sphinx]" value="1" <?php if($sphinx) echo 'checked';?> onclick="Ds('sphinx');"/> 开启</label>&nbsp;&nbsp;&nbsp;&nbsp;
<label><input type="radio" name="setting[sphinx]" value="0" <?php if(!$sphinx) echo 'checked';?> onclick="Dh('sphinx');"/> 关闭</label>
</td>
</tr>
...
<td>
<label><input type="radio" name="setting[upload_thumb]" value="1"  <?php if($upload_thumb) echo 'checked';?>/> 开启</label>&nbsp;&nbsp;&nbsp;&nbsp;
<label><input type="radio" name="setting[upload_thumb]" value="0"  <?php if(!$upload_thumb) echo 'checked';?>/> 关闭</label>
...
<td>
<label><input type="radio" name="setting[captcha_inquiry]" value="2"  <?php if($captcha_inquiry == 2) echo 'checked';?>> 继承会员组设置</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<label><input type="radio" name="setting[captcha_inquiry]" value="1"  <?php if($captcha_inquiry == 1) echo 'checked';?>> 全部启用</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<label><input type="radio" name="setting[captcha_inquiry]" value="0"  <?php if($captcha_inquiry == 0) echo 'checked';?>> 全部关闭</label>
</td>
</tr>
<tr>
<td class="tl">询价验证问题</td>
<td>
<label><input type="radio" name="setting[question_inquiry]" value="2"  <?php if($question_inquiry == 2) echo 'checked';?>> 继承会员组设置</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<label><input type="radio" name="setting[question_inquiry]" value="1"  <?php if($question_inquiry == 1) echo 'checked';?>> 全部启用</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<label><input type="radio" name="setting[question_inquiry]" value="0"  <?php if($question_inquiry == 0) echo 'checked';?>> 全部关闭</label>
</td>
</tr>
<tr>
