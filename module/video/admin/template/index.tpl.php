...
<label><input type="checkbox" name="poster" value="1"<?php echo $poster ? ' checked' : '';?>/> 封面&nbsp;</label>
...
<th>标题</th>
<th>会员</th>
<th><a href="javascript:;" onclick="Dq('order','<?php echo $order == 25 ? 26 : 25;?>');">时长 <img src="<?php echo DT_STATIC;?>image/ico-<?php echo $order == 26 ? 'asc' : ($order == 25 ? 'dsc' : 'ord');?>.png" width="11" height="11"/></a></th>
...
<td><?php echo sectotime($v['duration']);?></td>
