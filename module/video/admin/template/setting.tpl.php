...
<td>
<label><input type="radio" name="setting[autostart]" value="1"  <?php if($autostart) echo 'checked';?>/> 开启</label>&nbsp;&nbsp;&nbsp;&nbsp;
<label><input type="radio" name="setting[autostart]" value="0"  <?php if(!$autostart) echo 'checked';?>/> 关闭</label>
</td>
</tr>

<tr>
<td class="tl">允许上传的文件类型</td>
<td><input type="text" name="setting[upload]" size="70" value="<?php echo $upload;?>"/></td>
</tr>
...
<tr>
<td class="tl">显示发布者</td>
<td>
<label><input type="radio" name="setting[show_user]" value="1"  <?php if($show_user) echo 'checked';?>/> 开启</label>&nbsp;&nbsp;&nbsp;&nbsp;
<label><input type="radio" name="setting[show_user]" value="0"  <?php if(!$show_user) echo 'checked';?>/> 关闭</label>
</td>
</tr>
<tr>
