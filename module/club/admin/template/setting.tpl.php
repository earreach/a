...
<td><input type="text" size="3" name="setting[introduce_length]" value="<?php echo $introduce_length;?>"/> 字</td>
</tr>
<tr>
...
<td>
<label><input type="radio" name="setting[cat_property]" value="1"  <?php if($cat_property) echo 'checked';?>/> 开启</label>&nbsp;&nbsp;&nbsp;&nbsp;
<label><input type="radio" name="setting[cat_property]" value="0"  <?php if(!$cat_property) echo 'checked';?>/> 关闭</label>
</td>
</tr>
<tr>
<td class="tl">下载内容远程图片</td>
<td>
<label><input type="radio" name="setting[save_remotepic]" value="1"  <?php if($save_remotepic) echo 'checked';?>/> 开启</label>&nbsp;&nbsp;&nbsp;&nbsp;
<label><input type="radio" name="setting[save_remotepic]" value="0"  <?php if(!$save_remotepic) echo 'checked';?>/> 关闭</label>
</td>
</tr>
<tr>
<td class="tl">清除内容链接</td>
<td>
<label><input type="radio" name="setting[clear_link]" value="1"  <?php if($clear_link) echo 'checked';?>/> 开启</label>&nbsp;&nbsp;&nbsp;&nbsp;
<label><input type="radio" name="setting[clear_link]" value="0"  <?php if(!$clear_link) echo 'checked';?>/> 关闭</label>
</td>
</tr>
<tr>
<td class="tl">清除回复链接</td>
<td>
<label><input type="radio" name="setting[clear_alink]" value="1"  <?php if($clear_alink) echo 'checked';?>/> 开启</label>&nbsp;&nbsp;&nbsp;&nbsp;
<label><input type="radio" name="setting[clear_alink]" value="0"  <?php if(!$clear_alink) echo 'checked';?>/> 关闭</label>
</td>
</tr>
<tr>
<td class="tl">内容关联链接</td>
<td>
<label><input type="radio" name="setting[keylink]" value="1"  <?php if($keylink) echo 'checked';?>/> 开启</label>&nbsp;&nbsp;&nbsp;&nbsp;
<label><input type="radio" name="setting[keylink]" value="0"  <?php if(!$keylink) echo 'checked';?>/> 关闭</label>
&nbsp;&nbsp;
<a href="javascript:;" onclick="Dwidget('?file=keylink&item=<?php echo $moduleid;?>', '[<?php echo $MOD['name'];?>]关联链接管理');" class="t">[管理链接]</a>
</td>
</tr>
<tr>
<td class="tl">内容分表</td>
...
<td class="tl">全文搜索</td>
<td>
<label><input type="radio" name="setting[fulltext]" value="1" <?php if($fulltext==1){ ?>checked <?php } ?>/> LIKE</label>&nbsp;&nbsp;&nbsp;
<label><input type="radio" name="setting[fulltext]" value="2" <?php if($fulltext==2){ ?>checked <?php } ?>/> MATCH</label>&nbsp;&nbsp;&nbsp;&nbsp;
<label><input type="radio" name="setting[fulltext]" value="0" <?php if($fulltext==0){ ?>checked <?php } ?>/> 关闭</label>
...
<td>
<label><input type="radio" name="setting[manage_reason]" value="0" <?php if($manage_reason==0) echo 'checked';?>/> 选填</label>&nbsp;&nbsp;&nbsp;&nbsp;
<label><input type="radio" name="setting[manage_reason]" value="1" <?php if($manage_reason==1) echo 'checked';?>/> 必填</label>&nbsp;&nbsp;&nbsp;&nbsp;
</td>
</tr>
<tr>
<td class="tl">前台管理通知作者</td>
<td>
<label><input type="radio" name="setting[manage_message]" value="0" <?php if($manage_message==0) echo 'checked';?>/> 默认</label>&nbsp;&nbsp;&nbsp;&nbsp;
<label><input type="radio" name="setting[manage_message]" value="1" <?php if($manage_message==1) echo 'checked';?>/> 选中</label>&nbsp;&nbsp;&nbsp;&nbsp;
<label><input type="radio" name="setting[manage_message]" value="2" <?php if($manage_message==2) echo 'checked';?>/> 强制</label> <?php tips('默认 - 默认不选中通知选项，圈子或版主可以自行选中<br/>选中 - 默认选中通知选项，圈子或版主可以自行取消<br/>强制 - 默认选中通知选项，圈子或版主不能自行取消');?>
</td>
</tr>
<tr>
...
<td>
<label><input type="radio" name="setting[chat]" value="1" <?php if($chat) echo 'checked';?>/> 开启</label>&nbsp;&nbsp;
<label><input type="radio" name="setting[chat]" value="0" <?php if(!$chat) echo 'checked';?>/> 关闭</label>
</td>
</tr>
<tr>
...
<td><input type="text" size="5" name="setting[chat_poll]" value="<?php echo $chat_poll;?>"/> 秒<?php tips('群聊客户端需要定时请求服务器端数据，时间设置越短，信息发送的延迟越小，但是服务器压力越大，至少需要设置为1秒，一般建议设置为2秒-5秒之间的数值，推荐设置为3秒');?></td>
</tr>
<tr>
...
<label><input type="radio" name="setting[ip]" value="0"<?php if($ip == 0) echo ' checked';?>/> 关闭</label>
</td>
</tr>
</table>
</div>
...
<td>
<label><input type="radio" name="setting[show_html]" value="1"  <?php if($show_html){ ?>checked <?php } ?> onclick="Dd('show_html').style.display='';Dd('show_php').style.display='none';"/> 是</label>&nbsp;&nbsp;&nbsp;&nbsp;
<label><input type="radio" name="setting[show_html]" value="0"  <?php if(!$show_html){ ?>checked <?php } ?> onclick="Dd('show_html').style.display='none';Dd('show_php').style.display='';"/> 否</label>
</td>
</tr>
...
<td>
<label><input type="radio" name="setting[check_group]" value="2"  <?php if($check_group == 2) echo 'checked';?>> 继承会员组设置</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<label><input type="radio" name="setting[check_group]" value="1"  <?php if($check_group == 1) echo 'checked';?>> 全部启用</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<label><input type="radio" name="setting[check_group]" value="0"  <?php if($check_group == 0) echo 'checked';?>> 全部关闭</label>
</td>
</tr>
<tr>
<td class="tl">创建商圈验证码</td>
<td>
<label><input type="radio" name="setting[captcha_group]" value="2"  <?php if($captcha_group == 2) echo 'checked';?>> 继承会员组设置</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<label><input type="radio" name="setting[captcha_group]" value="1"  <?php if($captcha_group == 1) echo 'checked';?>> 全部启用</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<label><input type="radio" name="setting[captcha_group]" value="0"  <?php if($captcha_group == 0) echo 'checked';?>> 全部关闭</label>
</td>
</tr>
<tr>
<td class="tl">创建商圈验证问题</td>
<td>
<label><input type="radio" name="setting[question_group]" value="2"  <?php if($question_group == 2) echo 'checked';?>> 继承会员组设置</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<label><input type="radio" name="setting[question_group]" value="1"  <?php if($question_group == 1) echo 'checked';?>> 全部启用</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<label><input type="radio" name="setting[question_group]" value="0"  <?php if($question_group == 0) echo 'checked';?>> 全部关闭</label>
</td>
</tr>
...
<td>
<label><input type="radio" name="setting[check_add]" value="2"  <?php if($check_add == 2) echo 'checked';?>> 继承会员组设置</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<label><input type="radio" name="setting[check_add]" value="1"  <?php if($check_add == 1) echo 'checked';?>> 全部启用</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<label><input type="radio" name="setting[check_add]" value="0"  <?php if($check_add == 0) echo 'checked';?>> 全部关闭</label>
</td>
</tr>
<tr>
<td class="tl">商圈发帖验证码</td>
<td>
<label><input type="radio" name="setting[captcha_add]" value="2"  <?php if($captcha_add == 2) echo 'checked';?>> 继承会员组设置</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<label><input type="radio" name="setting[captcha_add]" value="1"  <?php if($captcha_add == 1) echo 'checked';?>> 全部启用</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<label><input type="radio" name="setting[captcha_add]" value="0"  <?php if($captcha_add == 0) echo 'checked';?>> 全部关闭</label>
</td>
</tr>
<tr>
<td class="tl">商圈发帖验证问题</td>
<td>
<label><input type="radio" name="setting[question_add]" value="2"  <?php if($question_add == 2) echo 'checked';?>> 继承会员组设置</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<label><input type="radio" name="setting[question_add]" value="1"  <?php if($question_add == 1) echo 'checked';?>> 全部启用</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<label><input type="radio" name="setting[question_add]" value="0"  <?php if($question_add == 0) echo 'checked';?>> 全部关闭</label>
</td>
</tr>
...
<td>
<label><input type="radio" name="setting[check_reply]" value="2"  <?php if($check_reply == 2) echo 'checked';?>> 继承会员组设置</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<label><input type="radio" name="setting[check_reply]" value="1"  <?php if($check_reply == 1) echo 'checked';?>> 全部启用</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<label><input type="radio" name="setting[check_reply]" value="0"  <?php if($check_reply == 0) echo 'checked';?>> 全部关闭</label>
</td>
</tr>
<tr>
<td class="tl">帖子回复验证码</td>
<td>
<label><input type="radio" name="setting[captcha_reply]" value="2"  <?php if($captcha_reply == 2) echo 'checked';?>> 继承会员组设置</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<label><input type="radio" name="setting[captcha_reply]" value="1"  <?php if($captcha_reply == 1) echo 'checked';?>> 全部启用</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<label><input type="radio" name="setting[captcha_reply]" value="0"  <?php if($captcha_reply == 0) echo 'checked';?>> 全部关闭</label>
</td>
</tr>
<tr>
<td class="tl">帖子回复验证问题</td>
<td>
<label><input type="radio" name="setting[question_reply]" value="2"  <?php if($question_reply == 2) echo 'checked';?>> 继承会员组设置</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<label><input type="radio" name="setting[question_reply]" value="1"  <?php if($question_reply == 1) echo 'checked';?>> 全部启用</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<label><input type="radio" name="setting[question_reply]" value="0"  <?php if($question_reply == 0) echo 'checked';?>> 全部关闭</label>
</td>
</tr>
...
<td>
<label><input type="radio" name="setting[fee_mode]" value="1"  <?php if($fee_mode == 1) echo 'checked';?>> 继承会员组设置</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<label><input type="radio" name="setting[fee_mode]" value="0"  <?php if($fee_mode == 0) echo 'checked';?>> 全部启用</label>
</td>
</tr>
<tr>
<td class="tl">会员收费使用</td>
<td>
<label><input type="radio" name="setting[fee_currency]" value="money"  <?php if($fee_currency == 'money') echo 'checked';?>/> <?php echo $DT['money_name'];?></label>&nbsp;&nbsp;&nbsp;&nbsp;
<label><input type="radio" name="setting[fee_currency]" value="credit"  <?php if($fee_currency == 'credit') echo 'checked';?>/> <?php echo $DT['credit_name'];?></label>
</td>
</tr>
<tr>
...
<tr>
<td class="tl">回复主题规则</td>
<td><textarea name="setting[tip_reply]" style="width:500px;height:50px;"><?php echo $tip_reply;?></textarea></td> 
</tr>
<tr>
<td class="tl">发布主题规则</td>
<td><textarea name="setting[tip_add]" style="width:500px;height:50px;"><?php echo $tip_add;?></textarea></td> 
</tr>
<tr>
<td class="tl"></td>
<td class="ts">显示在会员发布页面 支持HTML语法，常用代码：空格 &amp;nbsp; 换行  &lt;br/&gt;</td> 
</tr>
</table>
...
<td align="right"><a href="<?php echo gourl('https://www.destoon.com/doc/skill/94.html');?>" target="_blank" class="t">设置说明</a></td>
</tr>
