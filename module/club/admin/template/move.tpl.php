...
<td class="tl">移动方式</td>
<td>
<label><input type="radio" name="fromtype" value="gid" <?php echo $itemid ? '' : 'checked';?> id="f_1"/> 从指定商圈ID</label>&nbsp;&nbsp;
<label><input type="radio" name="fromtype" value="itemid" <?php echo $itemid ? 'checked' : '';?> id="f_2"/> 从指定帖子ID</label>
</td>
</tr>
<tr>
<td class="tl"></td>
