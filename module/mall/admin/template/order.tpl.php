...
<label><input type="checkbox" name="cod" value="1"<?php echo $cod ? ' checked' : '';?>/>到付</label>&nbsp;
<label><input type="checkbox" name="bill" value="1"<?php echo $bill ? ' checked' : '';?>/>转账</label>&nbsp;
...
<option value="0"<?php if($seller_star == 0) echo ' selected';?>>商家</option>
...
<input type="text" name="inviter" value="<?php echo $inviter;?>" size="15" placeholder="代理"/>&nbsp;
...
<td><a href="javascript:;" onclick="Dq('minamount','<?php echo $v['money'];?>',0);Dq('maxamount','<?php echo $v['money'];?>',0);Dq('mtype','money');"><span class="f_red"><?php echo $DT['money_sign'];?><?php echo $v['money'];?></a></td>
<td data-hide-1200="1"><a href="javascript:;" onclick="Dq('seller','<?php echo $v['seller'];?>');"><?php echo $v['shop'];?></a></td>
<td>
<a href="javascript:;" onclick="_user('<?php echo $v['seller'];?>');"><?php echo $v['seller'];?></a><br/>
<?php if($v['seller_star'] > 0) {?>
<a href="?moduleid=<?php echo $moduleid;?>&file=<?php echo $file;?>&action=show&id=<?php echo $id;?>&itemid=<?php echo $v['itemid'];?>#comment1"><img src="<?php echo DT_STATIC;?>image/star<?php echo $v['seller_star'];?>.gif" width="60" height="12" title="买家评价卖家：<?php echo $STARS[$v['seller_star']];?> 点击查看详情"/></a>
<?php } ?>
</td>
<td>
<a href="javascript:;" onclick="_user('<?php echo $v['buyer'];?>');"><?php echo $v['buyer'];?></a><br/>
<?php if($v['buyer_star'] > 0) {?>
<a href="?moduleid=<?php echo $moduleid;?>&file=<?php echo $file;?>&action=show&id=<?php echo $id;?>&itemid=<?php echo $v['itemid'];?>#comment2"><img src="<?php echo DT_STATIC;?>image/star<?php echo $v['buyer_star'];?>.gif" width="60" height="12" title="卖家评价买家：<?php echo $STARS[$v['buyer_star']];?> 点击查看详情"/></a>
<?php } ?>
</td>
...
<td><a href="?moduleid=<?php echo $moduleid;?>&file=<?php echo $file;?>&action=show&id=<?php echo $id;?>&itemid=<?php echo $v['itemid'];?>"><img src="<?php echo DT_STATIC;?>admin/view.png" width="16" height="16" title="详情" alt=""/></a></td>
</tr>
...
<td></td>
<td></td>
<td><a href="javascript:;" onclick="_preview('<?php echo $t['thumb'];?>');"><img src="<?php if($t['thumb']) { ?><?php echo $t['thumb'];?><?php } else { ?><?php echo DT_STATIC;?>image/nopic60.png<?php } ?>
" width="60" height="60" onerror="this.src=errimg;"/></a></td>
<td>
<div class="lt">
<a href="<?php echo $t['linkurl'];?>" target="_blank" class="t"><?php echo $t['title'];?></a>
</div>
</td>
<td><a href="javascript:;" onclick="Dq('minamount','<?php echo $t['price'];?>',0);Dq('maxamount','<?php echo $t['price'];?>',0);Dq('mtype','price');"><?php echo $DT['money_sign'];?><?php echo $t['price'];?></a></td>
<td><a href="javascript:;" onclick="Dq('minamount','<?php echo $t['number'];?>',0);Dq('maxamount','<?php echo $t['number'];?>',0);Dq('mtype','number');"><?php echo $t['number'];?></a></td>
<td></td>
<td></td>
<td></td>
<td></td>
<td></td>
<td data-hide-1200="1"></td>
<td></td>
<td></td>
</tr>
<?php } } ?>
