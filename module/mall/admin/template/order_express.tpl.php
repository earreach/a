...
<th>收件人</th>
<th>收件手机</th>
<th data-hide-1200="1" data-hide-1400="1" data-hide-1600="1" width="130">下单时间</th>
<th width="130">更新时间</th>
</tr>
<?php foreach($lists as $k=>$v) {?>
<tr align="center">
<td title="订单详情"><a href="javascript:;" onclick="Dwidget('?moduleid=<?php echo $moduleid;?>&file=<?php echo $file;?>&action=show&id=<?php echo $v['mallid'];?>&itemid=<?php echo $v['itemid'];?>', '订单详情');"><?php echo $v['itemid'];?></a></td>
<td><a href="javascript:;" onclick="Dq('fields',2,0);Dq('kw','='+this.innerHTML);"><?php echo $v['send_type'];?></a></td>
<td title="快递追踪"><a href="javascript:;" onclick="Dwidget('?moduleid=<?php echo $moduleid;?>&file=<?php echo $file;?>&action=show&id=<?php echo $v['mallid'];?>&itemid=<?php echo $v['itemid'];?>&job=express', '快递追踪');"><?php echo $v['send_no'];?></a></td>
<td><img src="<?php echo DT_STATIC;?>image/ico-copy.png" class="cp" title="复制" data-clipboard-action="copy" data-clipboard-target="#copy-<?php echo $v['itemid'];?>" onclick="Dtoast('快递单号 <?php echo $v['send_no'];?> 已复制');"/></td>
...
<td data-hide-1200="1" data-hide-1400="1" data-hide-1600="1"><a href="javascript:;" onclick="Dq('datetype','addtime',0);Dq('date',this.innerHTML);"><?php echo $v['addtime'];?></a></td>
...
<textarea id="copy-<?php echo $v['itemid'];?>"><?php echo $v['send_no'];?></textarea>
<?php } } ?>
</div>
