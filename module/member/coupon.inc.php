...
switch($action) {
	case 'get':
		...
		$db->query("INSERT INTO {$DT_PRE}finance_coupon (title,username,seller,addtime,fromtime,totime,price,cost,pid,mid,catid,itemids) VALUES ('$title','$_username','$r[username]','$DT_TIME','$r[fromtime]','$r[totime]','$r[price]','$r[cost]','$itemid','$r[mid]','$r[catid]','$r[itemids]')");
	...
	break;
	default:
		$condition = "fromtime<$DT_TIME AND totime>$DT_TIME AND number<amount AND open=1 AND username<>'$_username'";
