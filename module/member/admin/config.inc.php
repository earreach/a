...
$RT['file']['sendpush'] = '消息推送';
$RT['file']['alert'] = '贸易提醒';
$RT['file']['mail'] = '邮件订阅';
$RT['file']['message'] = '站内信件';
$RT['file']['favorite'] = '站内收藏';
$RT['file']['friend'] = '会员好友';
$RT['file']['blacklist'] = '黑名单';
...
$RT['action']['sms']['add'] = '短信增减';
$RT['action']['sms']['record'] = '增减记录';

$RT['action']['sendmail']['record'] = '发送记录';
$RT['action']['sendmail']['make'] = '获取列表';
$RT['action']['sendmail']['list'] = '邮件列表';
$RT['action']['sendmail']['download'] = '下载列表';
$RT['action']['sendmail']['delete'] = '删除列表';

$RT['action']['sendsms']['record'] = '发送记录';
$RT['action']['sendsms']['make'] = '获取列表';
$RT['action']['sendsms']['list'] = '号码列表';
$RT['action']['sendsms']['download'] = '下载列表';
$RT['action']['sendsms']['delete'] = '删除列表';

$RT['action']['sendpush']['record'] = '发送记录';
$RT['action']['sendpush']['make'] = '获取列表';
$RT['action']['sendpush']['list'] = '用户列表';
$RT['action']['sendpush']['list'] = '设备绑定';
$RT['action']['sendpush']['download'] = '下载列表';
$RT['action']['sendpush']['delete'] = '删除列表';
...
$RT['action']['friend']['edit'] = '修改好友';
$RT['action']['friend']['delete'] = '删除好友';
