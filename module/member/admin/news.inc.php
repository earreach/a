...
if(in_array($action, array('', 'check', 'reject', 'recycle'))) {
	...
	$sorder  = array('结果排序方式', '添加时间降序', '添加时间升序', '修改时间降序', '修改时间升序', '浏览次数降序', '浏览次数升序', '推荐级别降序', '推荐级别升序');
	$dorder  = array('addtime DESC', 'addtime DESC', 'addtime ASC', 'edittime DESC', 'edittime ASC', 'hits DESC', 'hits ASC', 'level DESC', 'level ASC');
