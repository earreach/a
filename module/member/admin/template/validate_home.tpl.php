...
<td><a href="?moduleid=<?php echo $moduleid;?>&file=<?php echo $file;?>&action=view&itemid=<?php echo $v['itemid'];?>"><?php echo $v['company'];?></a></td>
<td><a href="javascript:;" onclick="Dq('datetype','addtime',0);Dq('date',this.innerHTML);"><?php echo $v['adddate'];?></a></td>
<td><a href="javascript:;" onclick="Dq('fields',5,0);Dq('kw','='+this.innerHTML);"><?php echo $v['ip'];?></a></td>
...
<td><a href="?moduleid=<?php echo $moduleid;?>&file=<?php echo $file;?>&action=view&itemid=<?php echo $v['itemid'];?>"><img src="<?php echo DT_STATIC;?>admin/view.png" width="16" height="16" title="查看详情" alt=""/></a></td>
</tr>
<?php }?>
</table>
<div class="btns">
