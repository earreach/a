...
<th><a href="javascript:;" onclick="Dq('order','<?php echo $order == 1 ? 2 : 1;?>');">金额 <img src="<?php echo DT_STATIC;?>image/ico-<?php echo $order == 2 ? 'asc' : ($order == 1 ? 'dsc' : 'ord');?>.png" width="11" height="11"/></a></th>
<th>单位</th>
<th>模块</th>
<th>标题</th>
<th>会员名</th>
...
<td><a href="javascript:;" onclick="Dq('minamount','<?php echo $v['fee'];?>',0);Dq('maxamount','<?php echo $v['fee'];?>',0);Dq('currency','<?php echo $v['currency'];?>');"><span class="f_blue"><?php echo $v['fee'];?></span></a></td>
