...
<td><a href="javascript:;" onclick="Dwidget('?moduleid=<?php echo $moduleid;?>&file=record&username=<?php echo $username;?>', '<?php echo $DT['money_name'];?>流水');"><span class="f_red"><?php echo $DT['money_sign'];?><?php echo $amount;?></span></a></td>
</tr>
<tr>
...
<label><input type="radio" name="post[status]" value="3" id="s_3" onclick="S(this.value);"/> 通过</label>&nbsp;&nbsp;&nbsp;&nbsp;
<label><input type="radio" name="post[status]" value="2" id="s_2" onclick="S(this.value);" checked/> 待审</label>&nbsp;&nbsp;&nbsp;&nbsp;
<label><input type="radio" name="post[status]" value="1" id="s_1" onclick="S(this.value);"/> 拒绝</label>&nbsp;&nbsp;&nbsp;&nbsp;
</td>
</tr>
...
<td>
<label><input type="radio" name="post[validated]" value="1"/> 是</label>&nbsp;&nbsp;&nbsp;&nbsp;
<label><input type="radio" name="post[validated]" value="0" checked/> 否</label>
</td>
</tr>
<tr>
