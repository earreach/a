...
<td><a href="javascript:;" onclick="Dq('fields',6,0);Dq('kw','='+this.innerHTML);"><?php echo $v['typename'];?></a></td>
<td align="left" title="备注:<?php echo $v['note'];?>">&nbsp;<a href="javascript:;" onclick="Dq('fields',2,0);Dq('kw','<?php echo $v['addr'];?>');"><?php echo $v['address'];?></a></td>
<td><a href="javascript:;" onclick="Dq('fields',1,0);Dq('kw','='+this.innerHTML);"><?php echo $v['truename'];?></a></td>
<td><a href="javascript:;" onclick="Dq('mobile',this.innerHTML);"><?php echo $v['mobile'];?></a></td>
<td title="修改时间:<?php echo $v['editdate'];?>"><a href="javascript:;" onclick="Dq('date',this.innerHTML);"><?php echo $v['adddate'];?></a></td>
...
<input type="submit" value=" 批量删除 " class="btn-r" onclick="if(confirm('确定要删除选中地址吗？此操作将不可撤销')){this.form.action='?moduleid=<?php echo $moduleid;?>&file=<?php echo $file;?>&action=delete'}else{return false;}"/>
</div>
</form>
