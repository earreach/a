...
<tr>
<td class="tl"></td>
<td class="ts">以上信息在微信公众平台获取或设置</td>
</tr>
<tr>
...
<tr>
<td class="tl">小程序APPID</td>
<td><input name="setting[wxmini_appid]" type="text" size="30" value="<?php echo $wxmini_appid;?>"/><?php tips('如果没有开通小程序不需要填写，如果需要显示小程序二维码，请上传到api/weixin/image/wxmini.png，系统会自动读取');?></td>
</tr>
<tr>
<td class="tl">小程序APPSECRET</td>
<td><input name="setting[wxmini_appsecret]" type="text" size="60" value="<?php echo $wxmini_appsecret;?>"/></td>
</tr>
</table>
<div class="sbt">
