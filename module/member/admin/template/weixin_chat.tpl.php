...
?>
<style type="text/css">
#chat {width:auto;height:242px;overflow:auto;}
...
<tr>
<td bgcolor="#DEEAF2">
<a href="javascript:;" onclick="_preview('<?php echo $U['headimgurl'];?>');"><img src="<?php echo $U['headimgurl'];?>" width="48" height="48" class="avatar" style="margin:6px 16px 6px 6px;float:left;"/></a>
<div style="padding-top:6px;line-height:24px;"><strong style="font-size:14px;"><?php echo $U['nickname'];?></strong><br/><?php echo $U['sex'] == 1 ? '男，' : ($U['sex'] == 2 ? '女，' : '');?>来自<?php echo $U['country'].$U['province'].$U['city'];?></div>
</td>
</tr>
<tr>
...
<td><img src="api/weixin/image/media_upload.gif" onclick="Dfile(<?php echo $moduleid;?>, '', 'chat', 'jpg|amr|mp3|mp4');" class="c_p" title="上传多媒体文件文件(有效期3天)&#10;- 图片，支持jpg格式，最大128K&#10;- 语音，支持amr、mp3格式，最大256K&#10;- 视频，支持mp4格式，最大1M"/></td>
<td></td>
<td width="106"><input type="submit" value="发 送" class="btn-g" id="btn"/></td>
</tr>
</table>
</form>
...
$(function(){parent.$('.dbox').css('background', '#F1F2F3');});
Menuon(2);
</script>
