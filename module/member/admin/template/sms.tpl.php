...
<select name="mtype">
<option value="amount"<?php if($mtype == 'amount') echo ' selected';?>>增扣</option>
...
<th><a href="javascript:;" onclick="Dq('type','1',0);Dq('order','<?php echo $order == 1 ? 2 : 1;?>');">增加 <img src="<?php echo DT_STATIC;?>image/ico-<?php echo $order == 2 ? 'asc' : ($order == 1 ? 'dsc' : 'ord');?>.png" width="11" height="11"/></a></th>
<th><a href="javascript:;" onclick="Dq('type','2',0);Dq('order','<?php echo $order == 1 ? 2 : 1;?>');">扣除 <img src="<?php echo DT_STATIC;?>image/ico-<?php echo $order == 2 ? 'asc' : ($order == 1 ? 'dsc' : 'ord');?>.png" width="11" height="11"/></a></th>
...
<td><a href="javascript:;" onclick="Dq('minamount','<?php echo $v['balance'];?>',0);Dq('maxamount','<?php echo $v['balance'];?>',0);Dq('mtype','balance');"><?php echo $v['balance'] ? $v['balance'] : '';?></a></td>
