...
<tr>
<td class="tl">收件人</td>
<td><a href="javascript:;" onclick="_user('<?php echo $email;?>', 'email');"><?php echo $email;?></a></td>
</tr>
<tr>
<td class="tl">发送时间</td>
...
<div class="sbt"><input type="button" value="返 回" class="btn-g" onclick="history.back(-1);"/></div>
