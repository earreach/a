...
<td>
<label><input type="radio" name="setting[captcha_price]" value="2"  <?php if($captcha_price == 2) echo 'checked';?>> 继承会员组设置</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<label><input type="radio" name="setting[captcha_price]" value="1"  <?php if($captcha_price == 1) echo 'checked';?>> 全部启用</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<label><input type="radio" name="setting[captcha_price]" value="0"  <?php if($captcha_price == 0) echo 'checked';?>> 全部关闭</label>
</td>
</tr>
<tr>
<td class="tl">报价验证问题</td>
<td>
<label><input type="radio" name="setting[question_price]" value="2"  <?php if($question_price == 2) echo 'checked';?>> 继承会员组设置</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<label><input type="radio" name="setting[question_price]" value="1"  <?php if($question_price == 1) echo 'checked';?>> 全部启用</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<label><input type="radio" name="setting[question_price]" value="0"  <?php if($question_price == 0) echo 'checked';?>> 全部关闭</label>
</td>
</tr>
