...
<label><input type="checkbox" name="sign" value="1"<?php echo $sign ? ' checked' : '';?>/> 报名&nbsp;</label>
</td>
</tr>
</table>
</form>
...
<th>城市</th>
<th>会员</th>
<th><a href="javascript:;" onclick="Dq('order','<?php echo $order == 29 ? 30 : 29;?>');">报名 <img src="<?php echo DT_STATIC;?>image/ico-<?php echo $order == 30 ? 'asc' : ($order == 29 ? 'dsc' : 'ord');?>.png" width="11" height="11"/></a></th>
...
<td><a href="<?php echo $v['caturl'];?>" target="_blank"><?php echo $v['catname'];?></a></td><td><?php if($v['level']) {?><a href="javascript:;" onclick="Dq('level','<?php echo $v['level'];?>');"><img src="<?php echo DT_STATIC;?>admin/level_<?php echo $v['level'];?>.gif" title="<?php echo $v['level'];?>级" alt=""/></a><?php } ?></td>
...
<td><a href="javascript:;" onclick="Dq('kw','<?php echo $v['city'];?>');"><?php echo $v['city'];?></a></td>
...
<td><a href="javascript:;" onclick="Dwidget('?moduleid=<?php echo $moduleid;?>&file=<?php echo $file;?>&file=sign&id=<?php echo $v['itemid'];?>', '[<?php echo $v['alt'];?>] 报名管理');"><?php echo $v['orders'];?></a></td>
...
<td><a href="javascript:;" onclick="Dq('process','<?php echo $v['process'];?>');"><img src="<?php echo DT_STATIC;?>image/process_<?php echo $v['process'];?>.gif" title="<?php echo $v['fromdate'].'~'.$v['todate'];?>" alt=""/></a></td>
