...
<div class="thumbu">
<div><img src="<?php if($thumb) { ?><?php echo $thumb;?><?php } else { ?><?php echo DT_STATIC;?>image/upload-image.png<?php } ?>" id="pthumb" onerror="this.src='<?php echo DT_STATIC;?>image/upload-image.png';Dd('thumb').value='';" onclick="if(this.src.indexOf('upload-image.png') == -1){_preview(this.src, 1);}else{Dthumb(<?php echo $moduleid;?>,Dd('level').value==2 ? 400 : <?php echo $MOD['thumb_width'];?>,Dd('level').value==2 ? 300 : <?php echo $MOD['thumb_height'];?>, Dd('thumb').value);}"/></div>
<p><img src="<?php echo DT_STATIC;?>image/ico-upl.png" width="11" height="11" title="上传" onclick="Dthumb(<?php echo $moduleid;?>,Dd('level').value==2 ? 400 : <?php echo $MOD['thumb_width'];?>,Dd('level').value==2 ? 300 : <?php echo $MOD['thumb_height'];?>, Dd('thumb').value);"/><img src="<?php echo DT_STATIC;?>image/ico-del.png" width="11" height="11" title="删除" onclick="Dd('thumb').value='';Dd('pthumb').src='<?php echo DT_STATIC;?>image/upload-image.png';"/></p>
</div><span id="dthumb" class="f_red"></span>
</td>
</tr>
<tr>
<td class="tl"><span class="f_red">*</span> 展出时间</td>
...
<td><input name="post[address]" type="text" id="address" size="70" value="<?php echo $address;?>"/> <span id="daddress" class="f_red"></span></td>
</tr>
<tr>
...
<td><input name="post[sponsor]" id="sponsor" type="text" size="70" value="<?php echo $sponsor;?>"/> <span id="dsponsor" class="f_red"></span></td>
</tr>
<tr>
<td class="tl"><span class="f_hid">*</span> 承办单位</td>
<td><input name="post[undertaker]" type="text" size="70" value="<?php echo $undertaker;?>" /></td>
</tr>
<tr>
<td class="tl"><span class="f_hid">*</span> 官方网站</td>
<td><input name="post[homepage]" type="text" size="70" value="<?php echo $homepage;?>" /></td>
</tr>
<tr>
...
<td><input name="post[addr]" id="addr" type="text" size="70" value="<?php echo $addr;?>" /></td>
</tr>
<?php if($DT['postcode']) { ?>
<tr>
...
<td>
<label><input type="radio" name="post[sign]" value="1" <?php if($sign == 1) echo 'checked';?>/> 开启</label>
<label><input type="radio" name="post[sign]" value="0" <?php if(!$sign) echo 'checked';?>/> 关闭</label>
</td>
</tr>
<tr>
