...
<tr>
<td class="tl">首页展会预告月数</td>
<td><input type="text" size="3" name="setting[page_month]" value="<?php echo $page_month;?>"/><?php tips('从当前月往后计算，最大可设置为12');?></td>
</tr>

<tr>
<td class="tl">首页热门城市数量</td>
<td><input type="text" size="3" name="setting[page_city]" value="<?php echo $page_city;?>"/></td>
</tr>

<tr>
<td class="tl">首页热门展馆数量</td>
<td><input type="text" size="3" name="setting[page_hall]" value="<?php echo $page_hall;?>"/></td>
</tr>
...
<td>
<label><input type="radio" name="setting[captcha_sign]" value="2"  <?php if($captcha_sign == 2) echo 'checked';?>> 继承会员组设置</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<label><input type="radio" name="setting[captcha_sign]" value="1"  <?php if($captcha_sign == 1) echo 'checked';?>> 全部启用</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<label><input type="radio" name="setting[captcha_sign]" value="0"  <?php if($captcha_sign == 0) echo 'checked';?>> 全部关闭</label>
</td>
</tr>
<tr>
