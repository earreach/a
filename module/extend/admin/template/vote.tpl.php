...
<td><a href="javascript:;" onclick="Dwidget('?moduleid=<?php echo $moduleid;?>&file=<?php echo $file;?>&action=record&itemid=<?php echo $v['itemid'];?>', '[<?php echo $v['alt'];?>] 投票记录');"><?php echo $v['votes'];?></a></td>
<td><?php echo $v['hits'];?></td>
<td><?php echo $v['adddate'];?></td>
<td><a href="javascript:;" onclick="Dwidget('?moduleid=<?php echo $moduleid;?>&file=<?php echo $file;?>&action=record&itemid=<?php echo $v['itemid'];?>', '[<?php echo $v['alt'];?>] 投票记录');"><img src="<?php echo DT_STATIC;?>admin/poll.png" width="16" height="16" title="投票记录" alt=""/></a></td>
