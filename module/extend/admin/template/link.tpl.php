...
<td><a href="<?php echo gourl($v['linkurl']);?>" target="_blank"><?php echo $v['title'];?></td>
<td><?php if($v['thumb']) {?><a href="<?php echo gourl($v['linkurl']);?>" target="_blank"><img src="<?php echo $v['thumb'];?>" width="88" /><?php } ?></a></td>
<td><a href="javascript:;" onclick="Dq('type','<?php echo $v['thumb'] ? 2 : 1;?>');"><?php echo $v['thumb'] ? 'LOGO' : '文字';?></a></td>
