...
<th><a href="javascript:;" onclick="Dq('order','<?php echo $order == 3 ? 4 : 3;?>');">回复 <img src="<?php echo DT_STATIC;?>image/ico-<?php echo $order == 4 ? 'asc' : ($order == 3 ? 'dsc' : 'ord');?>.png" width="11" height="11"/></a></th>
...
<td><a href="javascript:;" onclick="Dwidget('?moduleid=<?php echo $moduleid;?>&file=<?php echo $file;?>&action=question&fid=<?php echo $v['itemid'];?>', '[<?php echo $v['alt'];?>] 表单选项');"><?php echo $v['question'];?></a></td>
<td><a href="javascript:;" onclick="Dwidget('?moduleid=<?php echo $moduleid;?>&file=<?php echo $file;?>&action=answer&fid=<?php echo $v['itemid'];?>', '[<?php echo $v['alt'];?>] 回复记录');"><?php echo $v['answer'];?></a></td>
<td><?php echo $v['hits'];?></td>
<td><?php echo $v['adddate'];?></td>
<td><a href="javascript:;" onclick="Dwidget('?moduleid=<?php echo $moduleid;?>&file=<?php echo $file;?>&action=question&fid=<?php echo $v['itemid'];?>', '[<?php echo $v['alt'];?>] 表单选项');"><img src="<?php echo DT_STATIC;?>admin/child.png" width="16" height="16" title="管理选项" alt=""/></a></td>
<td><a href="javascript:;" onclick="Dwidget('?moduleid=<?php echo $moduleid;?>&file=<?php echo $file;?>&action=answer&fid=<?php echo $v['itemid'];?>', '[<?php echo $v['alt'];?>] 回复记录');"><img src="<?php echo DT_STATIC;?>admin/poll.png" width="16" height="16" title="回复记录" alt=""/></a></td>
...
&nbsp;&nbsp;&nbsp;<?php echo $EXT['form_url'];?>index<?php echo DT_EXT;?>?itemid=表单ID&item=参数<br/>
