...
<td><input name="post[linkto]" type="text" id="linkto" size="70" value="<?php echo $linkto;?>"/></td>
</tr>
<tr>
...
<td>
<label><input type="radio" name="post[choose]" value="0" id="choose_0"<?php if(!$choose) echo ' checked';?> onclick="Dh('vote_num');"/> 单选</label>&nbsp;&nbsp;&nbsp;&nbsp;
<label><input type="radio" name="post[choose]" value="1" id="choose_1"<?php if($choose) echo ' checked';?> onclick="Ds('vote_num');"/> 多选</label>
</td>
</tr>
...
<td><input name="post[s<?php echo $i;?>]" type="text" id="s<?php echo $i;?>" size="70" value="<?php echo $$s;?>"/></td>
</tr>
<?php } ?>
<tr title="请保持时间格式">
