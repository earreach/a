...
<tr>
<td class="tl">关联简历模块</td>
<td>
<select name="setting[rid]">
<?php 
foreach($MODULE as $v) {
	if($v['module'] == 'resume') echo '<option value="'.$v['moduleid'].'"'.($rid == $v['moduleid'] ? ' selected' : '').'>'.$v['name'].'</option>';
} 
?>
</select><?php tips('如果无关联简历模块，将无法申请职位和管理人才');?>
</td>
</tr>
<tr>
