...
<td>
<label><input type="radio" name="post[sex]" value="1" <?php if($sex == 1) echo 'checked="checked"';?>/> 先生</label>
<label><input type="radio" name="post[sex]" value="2" <?php if($sex == 2) echo 'checked="checked"';?>/> 女士</label>
</td>
</tr>
<tr>
