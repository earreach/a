...
class job {
    ...
    function __construct($moduleid) {
		...
		$this->fields = array('catid','areaid','level','title','style','fee','introduce','thumb','department','total','minsalary','maxsalary','type','gender','marriage','education','minage','maxage','experience','status','hits','username','truename','telephone', 'mobile','address','email','qq','wx','ali','skype','sex','totime','editor','addtime','adddate','edittime','editdate','ip','template','linkurl','filepath','note','company');
    }
	...
	function update($itemid) {
		...
		$update = '';
		$keyword = $item['title'].','.$item['company'].','.$item['department'].','.strip_tags(cat_pos(get_cat($item['catid']), ',')).strip_tags(area_pos($item['areaid'], ','));
