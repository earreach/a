...
<th>大小</th>
<th>会员</th>
<th><a href="javascript:;" onclick="Dq('order','<?php echo $order == 25 ? 26 : 25;?>');">下载 <img src="<?php echo DT_STATIC;?>image/ico-<?php echo $order == 26 ? 'asc' : ($order == 25 ? 'dsc' : 'ord');?>.png" width="11" height="11"/></a></th>
...
<td><a href="javascript:;" onclick="Dq('fileext','<?php echo $v['fileext'];?>');"><img src="<?php echo DT_PATH;?>file/ext/<?php echo $v['fileext'];?>.gif"/></a></td>
