...
<td>
<label><input type="radio" name="post[logistic]" value="1" <?php if($logistic) echo 'checked';?> id="logistic_1"/> 是</label>&nbsp;&nbsp;&nbsp;
<label><input type="radio" name="post[logistic]" value="0" <?php if(!$logistic) echo 'checked';?> id="logistic_0"/> 否</label>
</td>
</tr>
