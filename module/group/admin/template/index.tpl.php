...
<option value="endtime"<?php if($datetype == 'endtime') echo ' selected';?>>结束时间</option>
</select>&nbsp;
...
<th>会员</th>
<th><a href="javascript:;" onclick="Dq('order','<?php echo $order == 35 ? 36 : 35;?>');">团购价 <img src="<?php echo DT_STATIC;?>image/ico-<?php echo $order == 36 ? 'asc' : ($order == 35 ? 'dsc' : 'ord');?>.png" width="11" height="11"/></a></th>
<th><a href="javascript:;" onclick="Dq('order','<?php echo $order == 41 ? 42 : 41;?>');">折扣 <img src="<?php echo DT_STATIC;?>image/ico-<?php echo $order == 42 ? 'asc' : ($order == 41 ? 'dsc' : 'ord');?>.png" width="11" height="11"/></a></th>
<th><a href="javascript:;" onclick="Dq('order','<?php echo $order == 31 ? 32 : 31;?>');">订单 <img src="<?php echo DT_STATIC;?>image/ico-<?php echo $order == 32 ? 'asc' : ($order == 31 ? 'dsc' : 'ord');?>.png" width="11" height="11"/></a></th>
<th><a href="javascript:;" onclick="Dq('order','<?php echo $order == 33 ? 34 : 33;?>');">销量 <img src="<?php echo DT_STATIC;?>image/ico-<?php echo $order == 34 ? 'asc' : ($order == 33 ? 'dsc' : 'ord');?>.png" width="11" height="11"/></a></th>
...
<td class="f_price" title="市场价：<?php echo $DT['money_sign'];?><?php echo $v['marketprice'];?> 节省：<?php echo $DT['money_sign'];?><?php echo $v['savemoney'];?>"><?php echo $DT['money_sign'];?><?php echo $v['price'];?></td>
...
<td><a href="javascript:;" onclick="Dq('process','<?php echo $v['process'];?>');"><?php echo $_process[$v['process']];?></a></td>
