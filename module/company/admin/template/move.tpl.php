...
<tr class="on">
<td>
<label><input type="radio" name="fromtype" value="areaid" id="f_2"/> 从地区ID</label>&nbsp;&nbsp;
<label><input type="radio" name="fromtype" value="userid" <?php echo $userid ? 'checked' : '';?> id="f_3"/> 从会员ID</label>
</td>
<td></td>
<td>&nbsp;目标地区</td>
</tr>
