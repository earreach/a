...
if(in_array($action, array('', 'check', 'expire', 'reject', 'recycle'))) {
	$sfields = array('模糊', '标题', '公司名', '联系人', '联系电话', '联系地址', '电子邮件', 'QQ', '微信', '网址', '会员名', '编辑', 'IP', '文件路径', '内容模板', '链接地址');
	$dfields = array('keyword', 'title', 'company', 'truename', 'telephone', 'address', 'email', 'qq', 'wx', 'homepage', 'username', 'editor', 'ip', 'filepath', 'template', 'linkurl');
