...
<th>会员</th>
<th><a href="javascript:;" onclick="Dq('order','<?php echo $order == 29 ? 30 : 29;?>');">留言 <img src="<?php echo DT_STATIC;?>image/ico-<?php echo $order == 30 ? 'asc' : ($order == 29 ? 'dsc' : 'ord');?>.png" width="11" height="11"/></a></th>
...
<td><a href="javascript:;" onclick="_preview('<?php echo $v['thumb'];?>');"><img src="<?php echo $v['thumb'];?>" width="80" class="thumb"/></a></td>
<td>
<div class="lt">
<?php if($v['status'] == 3) {?>
...
<td><a href="javascript:;" onclick="Dwidget('?moduleid=2&file=message&status=3&mid=<?php echo $moduleid;?>&tid=<?php echo $v['itemid'];?>', '[<?php echo $v['alt'];?>] 留言记录');"><?php echo $v['messages'];?></a></td>
