...
<tr>
<td class="tl">内容显示上下篇</td>
<td>
<label><input type="radio" name="setting[show_np]" value="1"  <?php if($show_np) echo 'checked';?>/> 开启</label>&nbsp;&nbsp;&nbsp;&nbsp;
<label><input type="radio" name="setting[show_np]" value="0"  <?php if(!$show_np) echo 'checked';?>/> 关闭</label>
