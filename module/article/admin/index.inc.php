...
if(in_array($action, array('', 'check', 'expire', 'reject', 'recycle'))) {
	$sfields = array('模糊', '标题', '简介', '标签', '作者', '来源', '来源网址', '会员名', '编辑', 'IP', '文件路径', '内容模板', '链接地址');
	$dfields = array('keyword', 'title', 'introduce', 'tag', 'author', 'copyfrom', 'fromurl', 'username', 'editor', 'ip', 'filepath', 'template', 'linkurl');
