...
foreach($GENDER as $k=>$v) {
	if($k == 0) continue;
?>
<label><input type="radio" name="post[gender]" id="gender_<?php echo $k;?>" value="<?php echo $k;?>"<?php echo $k == $gender ? ' checked' : '';?>/> <?php echo $v;?></label> 
<?php
}
?>
</td>
...
foreach($MARRIAGE as $k=>$v) {
	if($k == 0) continue;
?>
<label><input type="radio" name="post[marriage]" id="marriage_<?php echo $k;?>" value="<?php echo $k;?>"<?php echo $k == $marriage ? ' checked' : '';?>/> <?php echo $v;?></label> 
<?php
}
?>
</td>
...
foreach($EDUCATION as $k=>$v) {
	if($k == 0) continue;
?>
<label><input type="radio" name="post[education]" id="education_<?php echo $k;?>" value="<?php echo $k;?>"<?php echo $k == $education ? ' checked' : '';?>/> <?php echo $v;?></label> 
<?php
}
?>
&nbsp;&nbsp;(以上)
...
<td><input name="post[skill]" type="text" size="70" value="<?php echo $skill;?>"/></td>
</tr>
<tr>
<td class="tl"><span class="f_hid">*</span> 语言水平</td>
<td><input name="post[language]" type="text"  size="70" value="<?php echo $language;?>"/></td>
</tr>
...
foreach($TYPE as $k=>$v) {
	if($k == 0) continue;
?>
<label><input type="radio" name="post[type]" id="type_<?php echo $k;?>" value="<?php echo $k;?>"<?php echo $k == $type ? ' checked' : '';?>/> <?php echo $v;?></label> 
<?php
}
?>
</td>
...
<td>
<label><input type="radio" name="post[open]" value="3" <?php if($open == 3) echo 'checked';?>/> 开放</label>
<label><input type="radio" name="post[open]" value="1" <?php if($open == 1) echo 'checked';?>/> 关闭</label>
<label><input type="radio" name="post[open]" value="2" <?php if($open == 2) echo 'checked';?>/> 仅网站可见</label>
</td>
</tr>
<tr>
...
<td><input name="post[username]" type="text"  size="20" value="<?php echo $username;?>" id="username"/> &nbsp; <img src="<?php echo DT_STATIC;?>image/ico-user.png" width="16" height="16" title="会员资料" class="c_p" onclick="_user(Dd('username').value);"/> &nbsp;</td>
</tr>
<tr>
