...
<tr>
<td class="tl">关联招聘模块</td>
<td>
<select name="setting[jid]">
<?php 
foreach($MODULE as $v) {
	if($v['module'] == 'job') echo '<option value="'.$v['moduleid'].'"'.($rid == $v['moduleid'] ? ' selected' : '').'>'.$v['name'].'</option>';
} 
?>
</select><?php tips('如果无关联招聘模块，将无法投递简历');?>
</td>
</tr>
<tr>
