...
<input type="text" size="10" name="itemid" value="<?php echo $itemid;?>" placeholder="问题ID" title="问题ID"/>&nbsp;
...
<th>标题</th>
<th>会员</th>
<th><a href="javascript:;" onclick="Dq('order','<?php echo $order == 29 ? 30 : 29;?>');">悬赏 <img src="<?php echo DT_STATIC;?>image/ico-<?php echo $order == 30 ? 'asc' : ($order == 29 ? 'dsc' : 'ord');?>.png" width="11" height="11"/></a></th>
<th><a href="javascript:;" onclick="Dq('order','<?php echo $order == 27 ? 28 : 27;?>');">回答 <img src="<?php echo DT_STATIC;?>image/ico-<?php echo $order == 28 ? 'asc' : ($order == 27 ? 'dsc' : 'ord');?>.png" width="11" height="11"/></a></th>
...
<?php if($order == 23 || $order == 24) { ?><th><a href="javascript:;" onclick="Dq('order','<?php echo $order == 23 ? 24 : 23;?>');">评论 <img src="<?php echo DT_STATIC;?>image/ico-<?php echo $order == 24 ? 'asc' : ($order == 23 ? 'dsc' : 'ord');?>.png" width="11" height="11"/></a></th><?php } ?>
<th width="50"><a href="javascript:;" onclick="Dq('order','<?php echo $order == 31 ? 32 : 31;?>');">状态 <img src="<?php echo DT_STATIC;?>image/ico-<?php echo $order == 32 ? 'asc' : ($order == 31 ? 'dsc' : 'ord');?>.png" width="11" height="11"/></a></th>
<th width="40">修改</th>
</tr>
...
<?php } ?>
<div>
更新:<span class="c_p" onclick="Dq('datetype','updatetime');Dq('date',this.innerHTML);"><?php echo $v['updatetime'] ? timetodate($v['updatetime'], 6) : 'N/A';?></span><br/>
...
<td><a href="javascript:;" onclick="Dwidget('?moduleid=<?php echo $moduleid;?>&file=answer&qid=<?php echo $v['itemid'];?>', '[<?php echo $v['alt'];?>] 答案列表');"><?php echo $v['answer'];?></a></td>
...
<?php if($order == 23 || $order == 24) { ?><td><a href="javascript:;" onclick="Dwidget('?moduleid=3&file=comment&mid=<?php echo $moduleid;?>&itemid=<?php echo $v['itemid'];?>', '[<?php echo $v['alt'];?>] 评论列表');"><?php echo $v['comments'];?></a></td><?php } ?>
<td><a href="javascript:;" onclick="Dq('process','<?php echo $v['process'];?>');"><img src="<?php echo DT_SKIN;?>know_<?php echo $v['process'];?>.gif" title="<?php echo $PROCESS[$v['process']];?>"/></a></td>
