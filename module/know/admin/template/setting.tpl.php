...
<td>
<label><input type="radio" name="setting[answer_repeat]" value="1"  <?php if($answer_repeat) echo 'checked';?>/> 开启</label>&nbsp;&nbsp;&nbsp;&nbsp;
<label><input type="radio" name="setting[answer_repeat]" value="0"  <?php if(!$answer_repeat) echo 'checked';?>/> 关闭</label> <?php tips('如果关闭，同一个会员或者IP只能回答一次');?>
</td>
</tr>
<tr>
<td class="tl">有回复时发消息给提问者</td>
<td>
<label><input type="radio" name="setting[answer_message]" value="1"  <?php if($answer_message) echo 'checked';?>/> 开启</label>&nbsp;&nbsp;&nbsp;&nbsp;
<label><input type="radio" name="setting[answer_message]" value="0"  <?php if(!$answer_message) echo 'checked';?>/> 关闭</label>
</td>
</tr>
<tr>
...
<td>
<label><input type="radio" name="setting[check_answer]" value="2"  <?php if($check_answer == 2) echo 'checked';?>> 继承会员组设置</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<label><input type="radio" name="setting[check_answer]" value="1"  <?php if($check_answer == 1) echo 'checked';?>> 全部启用</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<label><input type="radio" name="setting[check_answer]" value="0"  <?php if($check_answer == 0) echo 'checked';?>> 全部关闭</label>
</td>
</tr>
<tr>
<td class="tl">发布答案启用验证码</td>
<td>
<label><input type="radio" name="setting[captcha_answer]" value="2"  <?php if($captcha_answer == 2) echo 'checked';?>> 继承会员组设置</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<label><input type="radio" name="setting[captcha_answer]" value="1"  <?php if($captcha_answer == 1) echo 'checked';?>> 全部启用</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<label><input type="radio" name="setting[captcha_answer]" value="0"  <?php if($captcha_answer == 0) echo 'checked';?>> 全部关闭</label>
</td>
</tr>
<tr>
<td class="tl">发布答案验证问题</td>
<td>
<label><input type="radio" name="setting[question_answer]" value="2"  <?php if($question_answer == 2) echo 'checked';?>> 继承会员组设置</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<label><input type="radio" name="setting[question_answer]" value="1"  <?php if($question_answer == 1) echo 'checked';?>> 全部启用</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<label><input type="radio" name="setting[question_answer]" value="0"  <?php if($question_answer == 0) echo 'checked';?>> 全部关闭</label>
</td>
</tr>
...
<tr>
<td class="tl">回答问题规则</td>
<td><textarea name="setting[tip_answer]" style="width:500px;height:50px;"><?php echo $tip_answer;?></textarea></td> 
</tr>
<tr>
<td class="tl">发布问题规则</td>
