...
<tr>
<td class="tl">独立地区选择</td>
<td>
<label><input type="radio" name="setting[edit_areaid]" value="1" <?php if($edit_areaid==1) echo 'checked';?>/> 开启</label>&nbsp;&nbsp;&nbsp;&nbsp;
<label><input type="radio" name="setting[edit_areaid]" value="0" <?php if($edit_areaid==0) echo 'checked';?>/> 关闭</label>&nbsp;<?php tips('默认使用会员所在地区，如果开启，地区以发布界面选择的地区为准');?>
</td>
</tr>
...
<td>
<label><input type="radio" name="setting[show_icat]" value="1"  <?php if($show_icat) echo 'checked';?>/> 开启</label>&nbsp;&nbsp;&nbsp;&nbsp;
<label><input type="radio" name="setting[show_icat]" value="0"  <?php if(!$show_icat) echo 'checked';?>/> 关闭</label>
</td>
</tr>
...
<td>
<label><input type="radio" name="setting[show_iarea]" value="1"  <?php if($show_iarea) echo 'checked';?>/> 开启</label>&nbsp;&nbsp;&nbsp;&nbsp;
<label><input type="radio" name="setting[show_iarea]" value="0"  <?php if(!$show_iarea) echo 'checked';?>/> 关闭</label>
</td>
</tr>
...
<td>
<label><input type="radio" name="setting[show_lcat]" value="1"  <?php if($show_lcat) echo 'checked';?>/> 开启</label>&nbsp;&nbsp;&nbsp;&nbsp;
<label><input type="radio" name="setting[show_lcat]" value="0"  <?php if(!$show_lcat) echo 'checked';?>/> 关闭</label>
</td>
</tr>
...
<td>
<label><input type="radio" name="setting[show_larea]" value="1"  <?php if($show_larea) echo 'checked';?>/> 开启</label>&nbsp;&nbsp;&nbsp;&nbsp;
<label><input type="radio" name="setting[show_larea]" value="0"  <?php if(!$show_larea) echo 'checked';?>/> 关闭</label>
</td>
</tr>
...
<td>
<label><input type="radio" name="setting[show_message]" value="1"  <?php if($show_message) echo 'checked';?>/> 开启</label>&nbsp;&nbsp;&nbsp;&nbsp;
<label><input type="radio" name="setting[show_message]" value="0"  <?php if(!$show_message) echo 'checked';?>/> 关闭</label>
</td>
</tr>
...
<td>
<label><input type="radio" name="setting[captcha_message]" value="2"  <?php if($captcha_message == 2) echo 'checked';?>> 继承会员组设置</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<label><input type="radio" name="setting[captcha_message]" value="1"  <?php if($captcha_message == 1) echo 'checked';?>> 全部启用</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<label><input type="radio" name="setting[captcha_message]" value="0"  <?php if($captcha_message == 0) echo 'checked';?>> 全部关闭</label>
</td>
</tr>
<tr>
<td class="tl">留言验证问题</td>
<td>
<label><input type="radio" name="setting[question_message]" value="2"  <?php if($question_message == 2) echo 'checked';?>> 继承会员组设置</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<label><input type="radio" name="setting[question_message]" value="1"  <?php if($question_message == 1) echo 'checked';?>> 全部启用</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<label><input type="radio" name="setting[question_message]" value="0"  <?php if($question_message == 0) echo 'checked';?>> 全部关闭</label>
</td>
</tr>
