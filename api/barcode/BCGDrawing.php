...
include_once(DT_ROOT.'/api/barcode/BCGColor.php');
include_once(DT_ROOT.'/api/barcode/BCGDrawException.php');
include_once(DT_ROOT.'/api/barcode/BCGDrawJPG.php');
include_once(DT_ROOT.'/api/barcode/BCGDrawPNG.php');
