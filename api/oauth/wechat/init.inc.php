...
define('OAUTH_CONNECT', 'https://open.weixin.qq.com/connect/qrconnect');
define('OAUTH_CALLBACK', DT_PATH.'api/oauth/'.$site.'/callback.php');
define('OAUTH_TOKEN', 'https://api.weixin.qq.com/sns/oauth2/access_token');
define('OAUTH_USERINFO', 'https://api.weixin.qq.com/sns/userinfo');
?>