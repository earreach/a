...
define('OAUTH_CONNECT', 'https://open.kuaishou.com/oauth2/authorize');
define('OAUTH_TOKEN', 'https://open.kuaishou.com/oauth2/access_token');
define('OAUTH_USERINFO', 'https://open.kuaishou.com/openapi/user_info');
?>