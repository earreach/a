...
$T = $db->get_one("SELECT itemid FROM {$DT_PRE}follow WHERE userid=$_userid AND fuserid=$fuserid LIMIT 0,1", 'CACHE');
if($T) {//取关
	$dc->remove("SELECT itemid FROM {$DT_PRE}follow WHERE userid=$_userid AND fuserid=$fuserid LIMIT 0,1");
