...
<body>
	<div style="width:100%;text-align:center;">
		...
		<img src="<?php echo DT_PATH;?>api/qrcode.php?auth=<?php echo encrypt($x->code_url, DT_KEY.'QRCODE');?>" style="width:180px;height:180px;margin:10px 0;"/>
		<div style="padding:0 16px;font-size:16px;color:#555555;line-height:32px;">		
		<?php
		if(DT_TOUCH) {
			echo $DT_MBS == 'weixin' ? '请长按上面的二维码<br/>选择识别图中二维码' : '请使用微信扫描二维码完成支付<br/><a href="https://app.destoon.com/scan/" rel="external" style="color:#2E7DC6;text-decoration:none;">如何扫描？</a>';
		} else {
	...
	<script type="text/javascript" src="<?php echo DT_STATIC;?>script/jquery-2.2.4.min.js?v=<?php echo DT_DEBUG ? DT_TIME : DT_REFRESH;?>"></script>
