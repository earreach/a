...
#require_once DT_ROOT.'/api/pay/'.$bank.'/rsa2/AopSdk.php';
require_once DT_ROOT.'/api/pay/'.$bank.'/rsa2/AlipayTradePagePayRequest.php';
require_once DT_ROOT.'/api/pay/'.$bank.'/rsa2/AopClient.php';
require_once DT_ROOT.'/api/pay/'.$bank.'/rsa2/AopEncrypt.php';
