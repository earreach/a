...
require DT_ROOT.'/api/pay/'.$bank.'/md5/config.inc.php';
require DT_ROOT.'/api/pay/'.$bank.'/md5/service.class.php';
$parameter = array(
	...
	'subject' => $charge_title ? $charge_title : '会员('.$_username.')充值(流水号:'.$orderid.')',	//商品名称，必填
	'body' => $DT['sitename'].'会员充值',      //商品描述，必填
