...
<div class="head">
	<div>
		...
		恭喜！您已经成功安装DESTOON网站内容管理系统V<?php echo DT_VERSION;?>
	</div>
</div>
<div class="body">
<div>
	...
	<td bgcolor="#FFFFFF"><a href="../admin.php?action=install"><?php echo $url;?>admin.php</a></td>
	</tr>
	<tr>
	...
	<br/><br/>
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;非常感谢选择DESTOON网站内容管理系统<br/><br/>
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;更多产品相关信息，敬请关注 <a href="https://www.destoon.com" target="_blank">www.destoon.com</a>
</div>
</div>
<div class="foot">
...
<input type="button" value="登录后台" onclick="window.location='../admin.php?action=install';"/>
