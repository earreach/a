...
$L['common_login'] = '您的帐号在别处(IP:{V0})登录，您被迫下线<br/>如果不是您操作的，请尽快修改登录密码';
/* upload.php */
...
$L['pass_mall_step'] = '商品阶梯价格设置错误';
$L['pass_mall_muti'] = '商品价格库存设置错误';
$L['pass_group_price'] = '请填写团购价';
$L['pass_group_mprice'] = '请填写市场价';
$L['pass_group_eprice'] = '团购价必须低于市场价';
$L['pass_skuid'] = '请填写条形编码';
$L['pass_skuid_exists'] = '条形编码已经存在';
$L['pass_username'] = '请填写会员名';//9.0
$L['pass_logo'] = '请上传LOGO';//9.0
