...
$L['msg_type_gbook'] = '内容长度应为10-5000字';//9.0
...
$L['msg_home_success'] = '发送成功';
$L['msg_home_member_failed'] = '发送失败，对方可能拒绝您的信息';
$L['msg_home_guest_failed'] = '发送失败，对方可能拒绝非会员的信息';
...
$L['msg_buy_address'] = '请先创建收货地址';//9.0
$L['msg_buy_addr'] = '请选择收货地址';//9.0
$L['msg_buy_addrerr'] = '收货地址不完整，请修改';//9.0
/* group/buy.inc.php*/
